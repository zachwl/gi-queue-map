import requests
import pandas as pd
from tools.config import fuel_indicies, standard_fields
from tools.utils import standardizeFuels, standardizeFields
...
#getMISOQueue().to_csv(f'C:/Users/zleig/Downloads/miso_test.csv', index=False)
#print('alldone')